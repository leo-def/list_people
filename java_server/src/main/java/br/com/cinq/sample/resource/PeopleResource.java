...
public class PeopleResource {
	...
	public Response pre(){
		return Response.ok()
				...
				.header("Access-Control-Allow-Headers", "Access-Control-Allow-Methods, Access-Control-Allow-Headers, Origin, X-Requested-With, Content-Type, Accept,  Access-Control-Allow-Origin")
				.build();
	}
